...
class NoteHelper
{
     ...
     * @param string $prefix
     *
     * @return string uuid string(key) with prefix
     * @example '7e57d004-2b97-0e7a-b45f-5387367791cd'
     *
     * Каждый уникальный идентификатор (SID) состоит из двух частей:
     * 1) Буквенная часть. Первые три буквы, указывающие на тип идентификатора.
